...
export async function create(
  ...
  rateLimitData?: { rate_limit_5h?: number; rate_limit_1d?: number; rate_limit_7d?: number; rate_limit_30d?: number }
): Promise<ApiKey> {
  ...
  if (rateLimitData?.rate_limit_30d && rateLimitData.rate_limit_30d > 0) {
